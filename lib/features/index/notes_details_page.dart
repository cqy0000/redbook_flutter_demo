...
class NotesDetailsPage extends StatefulWidget {
  const NotesDetailsPage({Key key, this.labelId, this.noteId}): super(key: key);
...
class _NotesDetailsPage extends State<NotesDetailsPage> with AutomaticKeepAliveClientMixin{
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 0.0,
            right: 0.0,
            child: notes['imagesUrl'].length >1
                 ? Row(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: notes['comments']['totalNum'] > 0
                       ? Text(
          ...
          Container(
            child: notes['comments']['results'] != null && notes['comments']['results'].length > 0 
                ...
                : new Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(
                        '暂无评论，快抢沙发吧',
                        style: TextStyle(fontSize: ScreenUtil().setSp(24), color: Color.fromRGBO(158, 158, 158, 1)),
                      )
                    ],
                  ),
                )
  ...
  _getNotesDetails() async {
    var url = 'http://localhost:3000/noteDetails?noteId=${widget.noteId}';
